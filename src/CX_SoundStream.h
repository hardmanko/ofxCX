...
namespace CX {
	...
	public:
		...
		struct OutputEventArgs {
			...
			float *outputBuffer;
			unsigned int bufferSize; //This is really "sampleFrames". (This * outputChannels) == the actual size of the buffer.
			int outputChannels;
		...
		ofEvent<CX_SoundStream::OutputEventArgs> outputEvent;
		ofEvent<CX_SoundStream::InputEventArgs> inputEvent;
